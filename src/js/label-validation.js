...
var ClassDiagramLabelValidator = /** @class */ (function () {
    function ClassDiagramLabelValidator() {
    }
    ClassDiagramLabelValidator.prototype.validate = function (value, label) {
    ...
    return ClassDiagramLabelValidator;
}());
exports.ClassDiagramLabelValidator = ClassDiagramLabelValidator;
var ClassDiagramLabelValidationDecorator = /** @class */ (function () {
    function ClassDiagramLabelValidationDecorator() {
    }
    ClassDiagramLabelValidationDecorator.prototype.decorate = function (input, result) {
    ...
    ClassDiagramLabelValidationDecorator.prototype.dispose = function (input) {
        var containerElement = input.parentElement;
        if (containerElement) {
